      ...
      <div className="relative">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
          ...
          <div className="mt-12 sm:mt-16 lg:mt-0">
            <div className="lg:-mr-16 lg:relative lg:m-0 lg:h-[calc(100vh-7rem)] xl:h-full lg:px-0">
    ...
    <div className="relative">
      <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-24 lg:px-8 flex flex-col-reverse lg:flex-row ">
        ...
        <div className="order-1 lg:order-1 mt-12 sm:mt-16 lg:mt-0">
          <div className="md:-ml-16 lg:relative lg:h-[calc(100vh-7rem)] xl:h-full lg:px-0">
            <Image
              loading="lazy"
              width="647"
              height="486"
